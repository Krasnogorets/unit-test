...
// Закрытие соединения с базой данных
    ...
    public void testDiscountCalc()
    {Assertions.assertEquals(38.5, calculator.calculatingDiscount(40.5, 2));
    }
    @Test
    @DisplayName("Проверка на недопустимые аргументы")
    public void testDiscountArgs() {
